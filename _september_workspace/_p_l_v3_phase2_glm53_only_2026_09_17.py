...
import os as _os_sc
assert _os_sc.path.basename(__file__) == '_p_l_v3_phase2_glm53_only_2026_09_17.py', '文件名漂移: ' + __file__
with open(__file__, 'r', encoding='utf-8') as _f_sc:
    _src_sc = _f_sc.read()
assert 'TRAE_SELFCHECK_2026_09_16_V3' in _src_sc
print('_p_l_v3_phase2_glm53_only_2026_09_17.py SELF-CHECK PASS')
