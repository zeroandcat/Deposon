...
- ✅ key 永不入 prompt / 永不入 JSON / 永不落盘(ark-[REDACTED]... e219 在所有产物中已 masked)
...
| **2 API key 安全** | D2 实现 step 才读 API key, V0 草稿期不读; 本任务 0 LLM 调用, 无 key 读取; ark-[REDACTED]... e219 在所有 JSON 中已 masked | ✅ |
