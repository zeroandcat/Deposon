...
| **M** | P-J 收敛盆地 | |ρ| < 0.3 → 死定理 | ρ=-0.9916, |ρ|=0.9916 | **PASS_for_death_theorem** |
...
- **JSON 路径**: `results\_adendum_B_pi_real_labels_v2_20260917_133852.json`
- **SHA-12**: `c725e08e0a1c`
...
- **JSON 路径**: `results\_adendum_C_pm_attack_surface_v2_20260917_133852.json`
- **SHA-12**: `d64e8e2e2518`
...
- **JSON 路径**: `results\_adendum_D_pc_r2_per_model_v2_20260917_133852.json`
- **SHA-12**: `d66792eea40e`
...
- **JSON 路径**: `results\_adendum_E_pd_supplement_v2_20260917_133852.json`
- **SHA-12**: `46d8dacb4721`
...
- **理由**: |ρ(potentialness, convergence)|=0.0336 < 0.3 (T_frac 辅助 ρ=0.9916); 势博弈度量与收敛比例无单调关系, 死定理定量遗产路线关闭
- **阈值**: |ρ| < 0.3 → 死定理定量遗产路线关闭
- **JSON 路径**: `results\_adendum_M_pj_convergence_basin_v2_20260917_133852.json`
- **SHA-12**: `8ab01a1e42ae`
...
- **阈值**: d_H 预测力 ≤ d_E+0.1
- **JSON 路径**: `results\_adendum_N_pn_coupling_v2_20260917_133852.json`
- **SHA-12**: `a32f3c8ba520`
...
- **JSON 路径**: `results\_adendum_O_pk_v2_three_way_v2_20260917_133852.json`
- **SHA-12**: `a30ff093305d`
...
| 不动项 | 状态 |
|---|---|
| 16 frozen anchor paths (16 frozen TOTAL: OK: 16 / FAIL: 0) | 0 触动 |
| 5 P-G anchors (P_G_HYPERBOLIC_TRANSPORT/CURVATURE_BOUND/LLM_CLIENT/HARNESS/FROZEN_BENCHMARK) | 0 触动 |
| 5 制品 JSON (corpus/v20/by_model/{kimi, GLM_1, GLM_2, coze, minimax}/) | 只读 |
| schema v1 (_v3x_frozen_schema_v1.json) | 0 触动 |
| 4 plugin spec (skill_a/b/c/d .py) | 0 触动 |
...
- **完成时点**: 2026-09-17T13:38:55.507429+08:00
