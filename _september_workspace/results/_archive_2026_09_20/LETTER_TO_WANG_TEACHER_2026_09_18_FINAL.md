...
(2) Adendum 17 项 = 11 PASS + 2 GRAY + 1 UNVERIFIED + 2 PARTIAL + 1 FAIL_NO_MODEL (GLM p-d 待查), 沿 §4 阈值诚实披露
...
- **Adendum 综合**: 17 项 = 11 PASS (含 M/N PASS_for_death) + 2 GRAY (H/O) + 1 UNVERIFIED (A) + 2 PARTIAL (F/G) + 1 FAIL_NO_MODEL (K) 诚实披露
