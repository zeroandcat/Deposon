...
| **D** | P-C per-model R² | per-model R² 与 η 关联 | unique=0/9, all_identical=False | **PASS** |
| **E** | P-D supplement | exp_3_4 = PASS (26/26) | chain=22/22, rewalk=True | **PASS** |
| **M** | P-J 收敛盆地 | |ρ| < 0.3 → 死定理 | ρ=-0.9916, |ρ|=0.9916 | **FAIL_for_death_theorem** |
...
- **JSON 路径**: `results\_adendum_B_b_v2_20260917_133358.json`
- **SHA-12**: `e1cc2f762481`
...
- **JSON 路径**: `results\_adendum_C_c_v2_20260917_133358.json`
- **SHA-12**: `6d8421f810bb`
...
- **JSON 路径**: `results\_adendum_D_d_v2_20260917_133358.json`
- **SHA-12**: `569358e7b016`
...
- **JSON 路径**: `results\_adendum_E_e_v2_20260917_133358.json`
- **SHA-12**: `185c056db7e8`
...
- **耗时**: 2.2555s
- **判死**: **FAIL_for_death_theorem**
- **理由**: |ρ(T_frac, convergence)|=-0.9916 ≥ 0.3; 收敛盆地与势博弈度量相关, 死定理定量遗产路线 NOT 关闭
- **阈值**: |ρ| < 0.3 → 死定理定量遗产路线关闭
- **JSON 路径**: `results\_adendum_M_m_v2_20260917_133358.json`
- **SHA-12**: `c86b6eb8bd9d`
...
- **阈值**: d_H 预测力 ≤ d_E+0.1
- **JSON 路径**: `results\_adendum_N_n_v2_20260917_133358.json`
- **SHA-12**: `a41158923f5a`
...
- **JSON 路径**: `results\_adendum_O_o_v2_20260917_133358.json`
- **SHA-12**: `6e48be802f77`
...
### §3.M M. P-J 收敛盆地 6760 资产穷举: **FAIL_for_death_theorem**

- **理由**: |ρ(T_frac, convergence)|=-0.9916 ≥ 0.3; 收敛盆地与势博弈度量相关, 死定理定量遗产路线 NOT 关闭
- **paper §7.2 处置**: 老实承认 M. P-J 收敛盆地 6760 资产穷举 FAIL_for_death_theorem, 禁止 reassign
...
- **完成时点**: 2026-09-17T13:34:00.709190+08:00
