...
| **M** | P-J 收敛盆地 | |ρ| < 0.3 → 死定理 | ρ=-0.9412, |ρ|=0.9412 | **PASS_for_death_theorem** |
...
- **JSON 路径**: `results\_adendum_B_pi_real_labels_v2_20260917_133705.json`
- **SHA-12**: `3d6422ed6142`
...
- **JSON 路径**: `results\_adendum_C_pm_attack_surface_v2_20260917_133705.json`
- **SHA-12**: `3aa723417780`
...
- **JSON 路径**: `results\_adendum_D_pc_r2_per_model_v2_20260917_133705.json`
- **SHA-12**: `630e9bed68d2`
...
- **JSON 路径**: `results\_adendum_E_pd_supplement_v2_20260917_133705.json`
- **SHA-12**: `d01dfc0978b7`
...
- **理由**: |ρ(potentialness, convergence)|=0.084 < 0.3 (T_frac 辅助 ρ=0.9412); 势博弈度量与收敛比例无单调关系, 死定理定量遗产路线关闭
- **阈值**: |ρ| < 0.3 → 死定理定量遗产路线关闭
- **JSON 路径**: `results\_adendum_M_pj_convergence_basin_v2_20260917_133705.json`
- **SHA-12**: `1788a0b3a839`
...
- **阈值**: d_H 预测力 ≤ d_E+0.1
- **JSON 路径**: `results\_adendum_N_pn_coupling_v2_20260917_133705.json`
- **SHA-12**: `cc0242ee2d79`
...
- **JSON 路径**: `results\_adendum_O_pk_v2_three_way_v2_20260917_133705.json`
- **SHA-12**: `3e2a6139c983`
...
- **完成时点**: 2026-09-17T13:37:07.683872+08:00
