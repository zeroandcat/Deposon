...
| **M** | P-J 收敛盆地 | |ρ| < 0.3 → 死定理 | ρ=-0.9409, |ρ|=0.9409 | **PASS_for_death_theorem** |
...
- **JSON 路径**: `results\_adendum_B_b_v2_20260917_133512.json`
- **SHA-12**: `010f873148a6`
...
- **JSON 路径**: `results\_adendum_C_c_v2_20260917_133512.json`
- **SHA-12**: `add9a7198276`
...
- **JSON 路径**: `results\_adendum_D_d_v2_20260917_133512.json`
- **SHA-12**: `dcdd42f38e23`
...
- **JSON 路径**: `results\_adendum_E_e_v2_20260917_133512.json`
- **SHA-12**: `957d27621517`
...
- **理由**: |ρ(potentialness, convergence)|=0.0549 < 0.3 (T_frac 辅助 ρ=0.9409); 势博弈度量与收敛比例无单调关系, 死定理定量遗产路线关闭
- **阈值**: |ρ| < 0.3 → 死定理定量遗产路线关闭
- **JSON 路径**: `results\_adendum_M_m_v2_20260917_133512.json`
- **SHA-12**: `59481213a823`
...
- **阈值**: d_H 预测力 ≤ d_E+0.1
- **JSON 路径**: `results\_adendum_N_n_v2_20260917_133512.json`
- **SHA-12**: `3279e9b821c5`
...
- **JSON 路径**: `results\_adendum_O_o_v2_20260917_133512.json`
- **SHA-12**: `39721d7aa6ce`
...
- **完成时点**: 2026-09-17T13:35:15.069831+08:00
